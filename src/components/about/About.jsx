            ...
            <div className='about-page'>
                ...
                <div className="contact-cards">
                    <div className="contact-card-1">
                        <p>
                            Ushbu kompaniya bilan sayohat qilish haqiqatan ham zavq! Ular har bir detaldan e’tibor ber                        </p>
                        <p style={{ textAlign: "right" }}>- Madina</p>
                    </div>

                    <div className="contact-card-1">
                        <p>
                            Sayohat yo‘riqlari bilimdon va do‘stona edilar. Har bir joy haqida madaniyat va tarixni ju                        </p>
                        <p style={{ textAlign: "right" }}>- Bobur</p>
                    </div>

                    <div className="contact-card-1">
                        <p>
                            Buyurtmadan qaytishgacha hamma narsa silliq va yaxshi tashkil etilgan. Men albatta ularning...                        </p>
